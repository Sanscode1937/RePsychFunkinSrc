...
class WeekEditorState extends MusicBeatState
{
	...
	override function create() {
		...
		missingFileText.setFormat(Paths.font("Milky Nice.ttf"), 24, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		txtTracklist.font = Paths.font("Milky Nice.ttf");
